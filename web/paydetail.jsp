<%-- 
    Document   : paydetail
    Created on : Nov 1, 2014, 11:29:18 AM
    Author     : Fenil Admin
--%>
                    ...
                    <div class="content_bg">
                        <div class="mainbar" style="background-color:#FFFFFF; color:#000000">
                            <div class="article">
                                ...
                                <form action="PayFineCheckServlet" method="post">
                                    <h3>Current due fine details:</h3>
                                    <c:if test="${empty dueFine}" >
                                        <lable>No fine is due.</lable>
                                        </c:if>

                                    <c:if test="${not empty dueFine}" >
                                        <table>
                                            <tr>
                                                <th>
                                            <div align="left">Card No:
                                            </div></th>
                                            <td>
                                                ${dueFine.carno}
                                            </td>
                                            ...
                                            <tr>
                                                <th>
                                            <div align="left">Due Fine Amount:
                                            </div></th>
                                            <td>
                                                $ ${dueFine.fine}
                                            </td>
                                        ...
                                        <p>
                                            <input type="text" name="card" value="${dueFine.carno}" hidden="true"/>
                                            <input type="text" name="fineamt" value=" ${dueFine.fine}" hidden="true" />
                                            <input type="submit" value="Pay" />
                                        </p>
                                    </c:if>
                                </form>
                                <c:remove var="dueFine" />
                                <form>
